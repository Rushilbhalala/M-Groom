...
<div class="panel panel-default checkout-step-01">
	...
	<!-- panel-heading -->
		<div class="panel-heading" style="background:#011F3D !important">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
		...
		<!-- panel-body  -->
	    <div class="panel-body" style="background:#004E92 !important">
	    <form name="payment" method="post">
			...
			<div class="form-group">
				<input type="submit" value="submit" name="submit" style="background:#ffffff !important" class="btn btn-primary">
