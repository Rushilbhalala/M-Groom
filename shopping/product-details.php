...
?>
				...
				<img  src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>" width="200" height="334" alt=""></a>
			</div><!-- /.image -->			
						...
						<div class="cart clearfix animate-effect" style="background-color: #100E17;">
							<div class="action">
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                ...
								                <input type="text" class="text-color-white" value="1">
							              </div>
							            </div>
									</div>
